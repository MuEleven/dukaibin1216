...
import com.bw.dukaibin1216.api.ApiService;
import com.bw.dukaibin1216.app.MyApp;
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        SharedPreferences dkb = MyApp.mContext.getSharedPreferences("杜凯宾", Context.MODE_PRIVATE);
                        String userId = dkb.getString("userId", "");
                        String sessionId = dkb.getString("sessionId", "");
